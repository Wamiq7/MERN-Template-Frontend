...
export const authRepository: IAuthRepository = {
  ...
  resendOtp: (email: string) =>
    makeApiCall("post", AUTH_API_PATHS.RESEND_OTP, { email }),

  forgotPassword: (email: string) =>
    makeApiCall("post", AUTH_API_PATHS.FORGOT_PASSWORD, { email }),
  ...
  refreshToken: (refreshToken: string) =>
    makeApiCall("post", AUTH_API_PATHS.REFRESH_TOKEN, { refreshToken }),
