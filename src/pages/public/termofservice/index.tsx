        ...
        <div className="mx-auto prose prose-sm/loose lg:prose-lg/loose dark:prose-dark">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="prose prose-sm/loose lg:prose-lg/loose dark:prose-dark">
                <p>
                  By accessing the website at https://example.com, you are
            ...
            <div className="space-y-2">
              ...
              <div className="prose prose-sm/loose lg:prose-lg/loose dark:prose-dark">
                ...
                <p>
                  ...
                  of these restrictions and may be terminated by Example at any
            ...
            <div className="space-y-2">
              ...
              <div className="prose prose-sm/loose lg:prose-lg/loose dark:prose-dark">
                ...
                <p>
                  Further, Example does not warrant or make any representations
