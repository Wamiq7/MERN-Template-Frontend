    ...
    <PageWrapper>
      <div className="mx-auto max-w-sm space-y-6 px-4">
        <div className="space-y-2 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">Enter your email and password to sign in to your account.</p>
        </div>
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type={passwordVisible ? 'text' : 'password'} required {...register('password')} />
